...
interface ChartDataPoint {
  timestamp: string;
  [key: string]: number | string; // Dynamic keys for each trader's equity
}
...
export function EquityChart() {
  ...
  // Fetch competition history (all participants' equity curves)
  ...
  // Get initial capital from first data point (assuming all start at same equity)
